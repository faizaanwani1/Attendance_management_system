...
class Student:
    def __init__(self,root):
        ...
        img3=Image.open(r"college_images\iStock-182059956_18390_t12.jpg")
       ...
       #bg
        ...
        main_frame.place(x=5,y=55,width=1550,height=650)
    ...
    def generate_dataset(self):
     if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.va_std_id.get() == "":
        ...
        try:
            ...
            # Fetch the student ID directly from the form
            ...
            while True:
                ...
                if face_cropped(my_frame) is not None:
                    ...
                    # Save images using the correct ID
