...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #student button
        img5=Image.open(r"college_images\gettyimages-1022573162.jpg")
        ...
        #help face button
        img8=Image.open(r"college_images\help-desk-customer-care-team-icon-blue-square-button-isolated-reflected-abstract-illustration-89657179.jpg")
